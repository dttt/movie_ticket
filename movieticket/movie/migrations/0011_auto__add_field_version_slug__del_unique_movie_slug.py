...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Movie', fields ['slug']
        db.delete_unique(u'movie_movie', ['slug'])

        # Adding field 'Version.slug'
        db.add_column(u'movie_version', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='nope', unique=True, max_length=110),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Version.slug'
        db.delete_column(u'movie_version', 'slug')

        # Adding unique constraint on 'Movie', fields ['slug']
        db.create_unique(u'movie_movie', ['slug'])
    ...
    models = {
        ...
        u'movie.version': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '110'})
        }
    }
