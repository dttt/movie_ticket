...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.total_cost'
        db.alter_column(u'reservation_reservation', 'total_cost', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Reservation.total_cost'
        db.alter_column(u'reservation_reservation', 'total_cost', self.gf('django.db.models.fields.IntegerField')(default=None))
