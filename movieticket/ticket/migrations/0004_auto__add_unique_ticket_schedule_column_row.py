...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Ticket', fields ['schedule', 'column', 'row']
        db.create_unique(u'ticket_ticket', ['schedule_id', 'column', 'row'])


    def backwards(self, orm):
        # Removing unique constraint on 'Ticket', fields ['schedule', 'column', 'row']
        db.delete_unique(u'ticket_ticket', ['schedule_id', 'column', 'row'])
