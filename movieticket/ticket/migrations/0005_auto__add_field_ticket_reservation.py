...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ticket.reservation'
        db.add_column(u'ticket_ticket', 'reservation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reservation.Reservation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ticket.reservation'
        db.delete_column(u'ticket_ticket', 'reservation_id')
    ...
    models = {
        ...
        u'ticket.ticket': {
            'Meta': {'unique_together': "(('schedule', 'column', 'row'),)", 'object_name': 'Ticket'},
            'column': ('django.db.models.fields.CharField', [], {'max_length': '2'}),
            'date_sold': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.IntegerField', [], {}),
            'reservation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['reservation.Reservation']", 'null': 'True', 'blank': 'True'}),
