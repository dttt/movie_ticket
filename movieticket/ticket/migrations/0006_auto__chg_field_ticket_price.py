...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.price'
        db.alter_column(u'ticket_ticket', 'price', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Ticket.price'
        db.alter_column(u'ticket_ticket', 'price', self.gf('django.db.models.fields.IntegerField')(default=None))
