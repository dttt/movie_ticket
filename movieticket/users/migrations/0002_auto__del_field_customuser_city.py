...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'users_customuser', 'city_id')


    def backwards(self, orm):
        # Adding field 'CustomUser.city'
        db.add_column(u'users_customuser', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['facility.City']),
                      keep_default=False)
